...
public class Q88_MergeSortedArrayTestData : TestDataBase
{
    protected override List<object[]> Data =>
    [
        [new int[] { 1, 2, 3, 0, 0, 0 }, 3, new int[] { 2, 5, 6 }, 3, new int[] { 1, 2, 2, 3, 5, 6 }], // Official test case
        [new int[] { 1 }, 1, Array.Empty<int>(), 0, new int[] { 1 }], // Single element in nums1
        [new int[] { 0 }, 0, new int[] { 1 }, 1, new int[] { 1 }], // Single element in nums2
...
{
    [Theory]
    [ClassData(typeof(Q88_MergeSortedArrayTestData))]
